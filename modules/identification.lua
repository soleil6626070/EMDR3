...
identification.steps = {
    ...
    { id = "nc",      screen = "ident_stage", label = "negative cognition",
      ...
      question_text = "What words go best with that picture, that express your negative belief about yourself, now?",
    ...
    { id = "pc",      screen = "ident_stage", label = "positive cognition",
      ...
      question_text = "When you bring up that picture, what would you prefer to believe about yourself, instead?",
    ...
    { id = "emotion", screen = "ident_stage", label = "emotions",
      ...
      question_text = "What emotions do you feel, right now?",
    ...
    { id = "body",    screen = "ident_stage", label = "body sensations",
      ...
      question_text = "Where do you feel it, in your body?",
